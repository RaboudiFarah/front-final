    ...
    axios.post(apiEndpoint, formData)
      .then((response) => {
        ...
        if (response.data.message === 'sucess login') {
          ...
          switch (userType) {
            case "Parent":
              navigate.push("/parent"); // Redirect to the parent dashboard
              break;
            case "Professor":
              navigate.push("/professor"); // Redirect to the professor dashboard
              break;
            case "Admin":
              navigate.push("/admin"); // Redirect to the admin dashboard
              break;
            default:
